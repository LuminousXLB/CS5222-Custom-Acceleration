...
#pragma HLS array_partition variable = input block factor = 1 dim = 2
#pragma HLS array_partition variable = weight1 block factor = 1 dim = 2
#pragma HLS array_partition variable = weight2 block factor = 1 dim = 2

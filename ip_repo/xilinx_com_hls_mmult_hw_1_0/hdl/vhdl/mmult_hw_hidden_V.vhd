...
entity mmult_hw_hidden_V_ram is 
    generic(
            DWIDTH     : integer := 16; 
            AWIDTH     : integer := 11; 
...
architecture rtl of mmult_hw_hidden_V_ram is 
...
architecture arch of mmult_hw_hidden_V is
    component mmult_hw_hidden_V_ram is
        port (
            clk : IN STD_LOGIC;
...
begin
    mmult_hw_hidden_V_ram_U :  component mmult_hw_hidden_V_ram
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
